var alter = require('../../../src/legacy/core_plugins/timelion/server/lib/alter.js');
var Chainable = require('../../../src/legacy/core_plugins/timelion/server/lib/classes/chainable');
...
module.exports = new Chainable('math', {
    ...
    fn: function mathChain(args, tlConfig) {
        var envName = (tlConfig.server._core.requestCounter || {value: 10000}).value + ' '; //Name of the enviroment (# of the request)
